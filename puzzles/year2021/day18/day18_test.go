...
func TestTreeExplose(t *testing.T) {
	testcases := [][]string{
		[]string{"[[[[[9,8],1],2],3],4]", "[[[[0,9],2],3],4]"},
		[]string{"[7,[6,[5,[4,[3,2]]]]]", "[7,[6,[5,[7,0]]]]"},
		[]string{"[[6,[5,[4,[3,2]]]],1]", "[[6,[5,[7,0]]],3]"},
		[]string{"[[3,[2,[1,[7,3]]]],[6,[5,[4,[3,2]]]]]", "[[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]"},
		[]string{"[[3,[2,[8,0]]],[9,[5,[4,[3,2]]]]]", "[[3,[2,[8,0]]],[9,[5,[7,0]]]]"},
	}
	for _, tc := range testcases {
		tree := NewTree(tc[0])
		ok := tree.Explode(0)
